...
> {
  ...
  constructor(
    @inject('datasources.mongatlas') dataSource: MongatlasDataSource, @repository.getter('MascotaRepository') protected mascotaRepositoryGetter: Getter<MascotaRepository>,
  ) {
