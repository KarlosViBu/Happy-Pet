...
export class EstrategiaCliente implements AuthenticationStrategy {
  name: string = 'cliente'; //se puede extender para una persona, vendedor o X role que se tengan dentro del sistema

  constructor(
    //aquí se inyectan servicios/repositorios...
